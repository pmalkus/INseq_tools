function table_out = annotate_Akk_TAsites_fixNCBI(TAsites)
...
% Genbank file found in current dirctory from '.gb'
...
sq=f.gene;
indices=[sq.Indices];
%For annotation, ADJUST genome numbering for NCBI error
if fixGenome==1    
